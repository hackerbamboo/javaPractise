...
public class SList {
  ...
  public static void main (String[] args) {
    ...
    SList testList = new SList();
    testList.insertFront(new Integer(12));
    testList.insertFront(new Integer(9));
    testList.insertFront(new Integer(6));

    System.out.println("Here is the list : " + testList.toString());

    testList.insertEnd(new Integer(12));
    testList.insertEnd(new Integer(15));
